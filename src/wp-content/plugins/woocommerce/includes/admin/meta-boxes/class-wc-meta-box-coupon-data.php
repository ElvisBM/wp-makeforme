	...
	public static function output( $post ) {
		...
		<div id="coupon_options" class="panel-wrap coupon_data">
			...
			<div id="general_coupon_data" class="panel woocommerce_options_panel"><?php
				...
				// Expiry date
				woocommerce_wp_text_input( array( 'id' => 'expiry_date', 'label' => __( 'Coupon expiry date', 'woocommerce' ), 'placeholder' => _x( 'YYYY-MM-DD', 'placeholder', 'woocommerce' ), 'description' => '', 'class' => 'date-picker', 'custom_attributes' => array( 'pattern' => "(0[1-9]|1[0-9]|2[0-9]|3[01])/(0[1-9]|1[012])/[0-9]{4}" ) ) );
