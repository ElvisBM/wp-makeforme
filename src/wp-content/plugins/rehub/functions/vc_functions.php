...
$autocompletemoduleids = array('small_thumb_loop', 'regular_blog_loop', 'grid_loop_mod', 'columngrid_loop', 'compactgrid_loop_mod', 'wpsm_featured', 'full_carousel', 'post_carousel_mod', 'wpsm_recent_posts_list', 'wpsm_three_col_posts');
...
$autocompletemodulenews = array('news_with_thumbs_mod', 'news_no_thumbs_mod');
...
//CAROUSEL SECTION
vc_map( array(
    "name" => __('Post carousel', 'rehub_framework'),
    "base" => "full_carousel",
    "icon" => "icon-f-carousel",
    "description" => __('Universal post carousel', 'rehub_framework'), 
    "category" => __('Content modules', 'rehub_framework'),
    "params" => rehub_vc_filter_formodules()
) );
vc_add_params("full_carousel", array(  
    array(
        "type" => "dropdown",
        "class" => "",
        ...
        "param_name" => "style",
        "value" => array(
            __('Text outside image', 'rehub_framework') => "2",            
            __('Text inside images', 'rehub_framework') => "1",                  
        ),
    ),   
    array(
        "type" => "dropdown",
        ...
        "param_name" => "showrow",
        "value" => array(
            __('4 items per row', 'rehub_framework') => "4",
            __('3 items per row', 'rehub_framework') => "3",             
            __('5 items per row', 'rehub_framework') => "5",
            __('6 items per row', 'rehub_framework') => "6",                                                   
        ),
    ),     
    array(
        "type" => "checkbox",
    ...
    array(
        ...
        "class" => "",
        "group" => __('Carousel control', 'rehub_framework'),        
        "heading" => __('Add badge?', 'rehub_framework'),
        "value" => array(__("Yes", "rehub_framework") => true ),
        "param_name" => "add_badge",         
    ),     
    array(
        "type" => "textfield",
        "heading" => __("Name for stamp", "rehub_framework"),
    ...
    array(
        'type' => 'colorpicker',
        'heading' => __( 'Color for stamp', 'rehub_framework' ),
        'param_name' => 'color_stamp',
        "group" => __('Carousel control', 'rehub_framework'),         
        "description" => __('Leave blank to keep it green', 'rehub_framework'),         
        'dependency' => array(
            'element' => 'add_badge',
            'not_empty' => true,
        ),               
...
vc_remove_param("full_carousel", "enable_pagination");
...
vc_add_params("wpsm_woogrid", array( 
    ...
    array(
        "type" => "checkbox",
        "class" => "",      
        "heading" => __('Disable thumbs action?', 'rehub_framework'),
        "group"  => __('Control', 'rehub_framework'),
        "value" => array(__("Yes", "rehub_framework") => true ),
        "param_name" => "disable_thumbs",         
    ),                 
)); 
...
vc_map( array(
    ...
    "params" => array(  
        ...
        array(
            "type" => "checkbox",
            "class" => "",
            "heading" => __('Add link to title?', 'rehub_framework'),
            "value" => array(__("Yes", "rehub_framework") => true ),
            "param_name" => "link",         
        ),                
        array(
