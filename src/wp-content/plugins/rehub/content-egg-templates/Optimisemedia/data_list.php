...
$product_price_update = get_post_meta( get_the_ID(), '_cegg_last_update_Otimisemedia', true );
$product_keyword_update = get_post_meta( get_the_ID(), '_cegg_last_bykeyword_update_Otimisemedia', true );
