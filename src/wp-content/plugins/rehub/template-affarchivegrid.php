                    ...
                    <?php if (get_post_meta( $post->ID, 'rehub_aff_sticky', true) == '1') :?><span class="vip_badge"><i class="fa fa-thumbs-o-up"></i></span><?php endif ?> 
                        ...
                        <div class="buttons_col">
                            ...
                            <?php if(!empty($offer_coupon_date)) : ?>
                                ...
                                ?>
                            <?php endif ;?>                            
                                <div><a class="re_track_btn btn_offer_block" href="<?php the_permalink(); ?>"><?php if($offer_btn_text !='') :?><?php echo $offer_btn_text ; ?><?php elseif(rehub_option('rehub_btn_text') !='') :?><?php echo rehub_option('rehub_btn_text') ; ?><?php else :?><?php _e('Buy this item', 'rehub_framework') ?><?php endif ;?></a></div>
                            </div>
                        </div>
