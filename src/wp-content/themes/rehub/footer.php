  ...
  <div class="container clearfix">
    <div class="footer_most_bottom">
		...
		<?php if(rehub_option('rehub_footer_text')) : ?>
			<?php echo rehub_kses(rehub_option('rehub_footer_text')); ?>
		<?php endif; ?>
		<?php if(rehub_option('rehub_footer_logo')) : ?><div class="floatright ml15 mr15"><img src="<?php echo rehub_option('rehub_footer_logo'); ?>" alt="<?php bloginfo( 'name' ); ?>" /></div><?php endif; ?>	</div>		
    </div>
  </div>
</footer>
<!-- FOOTER --> 
