...
<form  role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
  	<input type="text" name="s" placeholder="Digite o que precisa, buscamos para você :)" <?php if (rehub_option('rehub_ajax_search') == '1') {echo 'class="re-ajax-search" autocomplete="off"';} ?> data-posttype="<?php echo $posttype;?>">
